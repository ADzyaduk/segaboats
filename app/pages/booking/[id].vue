  ...
  <div class="py-8 min-h-[80vh]">
    <UContainer class="max-w-2xl">
      ...
      <div v-else-if="booking" class="space-y-6">
        ...
        <UCard v-if="!isTelegram" class="bg-gradient-to-r from-sky-50 to-blue-50 dark:from-sky-950 dark:to-blue-950 border-sky-200 dark:border-sky-800">
          <div class="flex items-start gap-4">
            <div class="w-12 h-12 bg-sky-100 dark:bg-sky-900/50 rounded-full flex items-center justify-center flex-shrink-0">
